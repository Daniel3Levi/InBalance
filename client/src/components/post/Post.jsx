  ...
  return (
    <div className="post">
      ...
      <p className="postDescription">
        יוגה הוא שם כללי למספר תורות חכמה מיסטיות או רוחניות, שמקורן בהודו. כיום
        במערב לרוב השם מתייחס לשיטת אימון גופני עם אלמנטים מעטים ושוליים של
        רוחניות. על פי פילוסופיית היוגה, במצב זה התודעה שלווה ואנחנו פוגשים
        ...
        שמטרתו להרגיע את תנודות התודעה, ודרכו המתרגל מקבל כלים להתמודד עם הקשיים
        האישיים שלו, פיזיים או נפשיים.
      </p>
    </div>
  );
}
